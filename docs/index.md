...
I've grouped things into three categories, hardware, storage, and services. Services are deployed using a standard Docker daemon and compose files. Beyond compose I don't use many automations for this since I use them at work more than enough, and I want to keep my manual CLI skills sharp. 
...
TLDR it's a Linux server running Docker behind a Ubiquiti networking stack. Not much more to it than that.